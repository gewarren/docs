...
| [Implicit global using directives in C# projects](sdk/6.0/implicit-namespaces.md) | ✔️ | ❌ | Preview 7 |
| [Implicit global using directives disabled](sdk/6.0/implicit-namespaces-rc1.md) | ✔️ | ❌ | RC 1|
