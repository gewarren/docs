...
- The default value is 6.02 if any compiler option in the following list is set:
  - [-target:appcontainerexe](/dotnet/csharp/language-reference/compiler-options/optimizations)
  - [-target:winmdobj](/dotnet/csharp/language-reference/compiler-options/optimizations)
  - [-platform:arm](/dotnet/csharp/language-reference/compiler-options/optimizations)
