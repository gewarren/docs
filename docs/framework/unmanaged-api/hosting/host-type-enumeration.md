...
helpviewer_keywords: 
     - "HOST_TYPE enumeration [.NET Framework hosting]"
       s.assetid: 51f848be-84c5-4036-9839-c762c576bbf5
       opic_type: 
     - "apiref"
       --
        HOST_TYPE Enumeration
       ontains values that specify the type of host that is launching an application.  
  ...
  "     "
        ...
        HOST_TYPE_APPLAUNCH`|Launch the application from AppLaunch.exe.<br /><br /> Use this value for partially trusted applications.|  
              ...
              HOST_TYPE_DEFAULT`|Same as HOST_TYPE_APPLAUNCH.|  ''
                    ...
                    ET Framework Versions:** [!INCLUDE[net_current_v20plus](../../../../includes/net-current-v20plus-md.md)]  
